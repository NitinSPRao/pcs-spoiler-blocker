...
| Homepage games widget | `ul.hp-games li div` (pill background — PCS puts styling on `div` child, not `li`), `ul.hp-games li div a` (link color). Targeting `li` alone is insufficient. |
